# PATCHLAB v0.4.2 — Routing + Prompt Intelligence
...
- Restored the missing filter-to-effects/master audio connection.
- Lead and bass now remain audible after prompt generation.
- Connected the LFO output to filter cutoff modulation.
- Removing the LFO-to-cutoff cable now disables that modulation.
